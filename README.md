...
Starting with 4D 21, the recommended way to install wmd_tinyMD (and any ogTools component) is through the **Dependencies Manager** using the **GitHub repository**:
